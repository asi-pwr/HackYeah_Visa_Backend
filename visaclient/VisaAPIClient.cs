...
namespace Vdp.Lib
{
    ...
    .AddJsonFile("appsettings.json").Build();
        ...
        {
            string requestURL = _configuration["visaUrl"] + path;
            string userId = _configuration["userId"];
            string password = _configuration["password"];
            string certificatePath = _configuration["cert"];
            string certificatePassword = _configuration["certPassword"];
            string responseBody = "";
        ...
        {
            string requestURL = _configuration["visaUrl"] + baseUri + resourcePath + "?" + queryString;
        ...
        {
            string sharedSecret = _configuration["sharedSecret"];
